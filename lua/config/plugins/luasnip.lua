...
local marks = {
    ...
    function()
        return fmt("<{}>", i(1, _G.informations.username))
    end,
    function()
        return fmt("<{}{}>", { i(1, os.date("%d-%m-%y")), i(2, ", " .. _G.informations.username) })
    end,
    function()
        return fmt("<{}{}>", { i(1, _G.informations.username), i(2, " " .. _G.informations.email) })
    end,
    function()
        return fmt("<{}{}{}>", {
            i(1, os.date("%d-%m-%y")),
            i(2, ", " .. _G.informations.username),
            i(3, " " .. _G.informations.email),
        })
    end,
}
...
local todo_snippet_nodes = function(aliases, opts)
    ...
    local format_strings = opts.ctype == 1 and "<> <>: <><>" or [[<>
<>: <> <>]]
