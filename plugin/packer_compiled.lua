...
_G.packer_plugins = {
  ["AutoSave.nvim"] = {
    ...
    url = "https://hub.xn--p8jhe.tw/Pocco81/AutoSave.nvim"
  },
  ["Comment.nvim"] = {
  ...
  auto_mkdir = {
    ...
    url = "https://hub.xn--p8jhe.tw/DataWraith/auto_mkdir"
  },
  ["beacon.nvim"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/beacon.nvim",
    url = "https://hub.xn--p8jhe.tw/danilamihailov/beacon.nvim"
  },
  ["bufferline.nvim"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/bufferline.nvim",
    url = "https://hub.xn--p8jhe.tw/akinsho/bufferline.nvim"
  },
  ["cmp-buffer"] = {
    loaded = true,
  ...
  ["dashboard-nvim"] = {
    ...
    url = "https://hub.xn--p8jhe.tw/glepnir/dashboard-nvim"
  },
  ["formatter.nvim"] = {
    loaded = true,
  ...
  ["lsp-colors.nvim"] = {
    ...
    url = "https://hub.xn--p8jhe.tw/folke/lsp-colors.nvim"
  },
  ["lspkind-nvim"] = {
    loaded = true,
  ...
  ["lualine.nvim"] = {
    ...
    url = "https://hub.xn--p8jhe.tw/nvim-lualine/lualine.nvim"
  },
  ["lush.nvim"] = {
    loaded = true,
  ...
  ["nvim-autopairs"] = {
    ...
    url = "https://hub.xn--p8jhe.tw/windwp/nvim-autopairs"
  },
  ["nvim-cmp"] = {
    loaded = true,
  ...
  rainbow = {
    ...
    url = "https://hub.xn--p8jhe.tw/luochen1990/rainbow"
  },
  sniprun = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/sniprun",
    url = "https://hub.xn--p8jhe.tw/michaelb/sniprun"
  },
  ["telescope-fzf-native.nvim"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/telescope-fzf-native.nvim",
    url = "https://hub.xn--p8jhe.tw/nvim-telescope/telescope-fzf-native.nvim"
  },
  ["telescope.nvim"] = {
    loaded = true,
  ...
  ["toggleterm.nvim"] = {
    ...
    url = "https://hub.xn--p8jhe.tw/akinsho/toggleterm.nvim"
  },
  ["venn.nvim"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/venn.nvim",
    url = "https://hub.xn--p8jhe.tw/jbyuki/venn.nvim"
  },
  ["vim-easy-align"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/vim-easy-align",
    url = "https://hub.xn--p8jhe.tw/junegunn/vim-easy-align"
  },
  ["vim-search-pulse"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/vim-search-pulse",
    url = "https://hub.xn--p8jhe.tw/inside/vim-search-pulse"
  },
  ["vim-startuptime"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/vim-startuptime",
    url = "https://hub.xn--p8jhe.tw/dstein64/vim-startuptime"
  },
  ["vim-surround"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/vim-surround",
    url = "https://hub.xn--p8jhe.tw/tpope/vim-surround"
  },
  ["vim-translator"] = {
    loaded = true,
  ...
  vimcdoc = {
    ...
    url = "https://hub.xn--p8jhe.tw/yianwillis/vimcdoc"
  }
}
